...
const Signin = () => {
  ...
  const handleOAuthLogin = async (provider) => {
    try {
      ...
      setErrorMessage(`Unable to login with ${provider}.`);
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    <div className="signin-container">
      <div className="signin-card">
        ...
        {/* Social Login */}
        <button type="button" className="google-btn" onClick={() => handleOAuthLogin("google")} disabled={submitting}> 
        ...
        <button type="button" className="apple-btn" onClick={() => handleOAuthLogin("apple")} disabled={submitting}> 
